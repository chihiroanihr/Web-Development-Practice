/*
A utility function for parsing data (read) from the file system.
...
import fs from "fs"; // A Node.js module that lets you read files from the file system.
import path from "path"; // A Node.js module that lets you manipulate file paths.
import matter from "gray-matter"; // A library that lets you parse the metadata in each markdown file.
// Libraries to render markdown content.
...
// Returns array of objects: post ID as params key.
...
// Async keyword added to getPostData because we need to use await for remark library.
export async function getPostData(id) {
  ...
  // Use remark library to convert markdown into HTML string
